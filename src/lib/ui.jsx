...
export const styles = {
  ...
  fab: { position: "fixed", bottom: 84, left: "50%", transform: "translateX(min(202px, 50vw - 48px))", width: 56, height: 56, borderRadius: "50%", border: "none", color: "#fff", fontSize: 30, cursor: "pointer", boxShadow: "0 6px 20px rgba(0,0,0,.3)", zIndex: 50 },
